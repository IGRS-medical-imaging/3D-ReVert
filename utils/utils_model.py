...
sys.path.append(os.path.join(proj_dir, "Pointnet2.PyTorch/pointnet2"))
import utils.pointnet_utils as pn2
sys.path.append(os.path.join(proj_dir, "emd"))
#import emd_module as emd
sys.path.append(os.path.join(proj_dir, "ChamferDistancePytorch"))
import dist_chamfer_3D
from utils.ChamferDistancePytorch.f_score import fscore
...
def get_spherepoints(num_points, radius):
    ball_name = './Sphere_PC/%d.xyz' % num_points
